#ifndef __FLV_MUXER_VIDEO_AUDIO_H__
#define __FLV_MUXER_VIDEO_AUDIO_H__

#include "libflv/include/flv-writer.h"
#include "libflv/include/flv-muxer.h"
#include <stdio.h>
#include <assert.h>
#include "debug.h"
...
typedef void(*flv_muxer_cb)(void* flv, int type, const void* data, size_t bytes, uint32_t timestamp);

struct flv_muxer_context_t
{
	flv_muxer_t* muxer;
	flv_muxer_cb cbfun;
	int64_t      a_s_pts;
...
#endif // !__FLV_MUXER_VIDEO_AUDIO_H__
